function [BW3, param3D, STNames, CLR] = fun_Render3D(matffn, matfd, FractionName, iSec, bFinal, param3D, CamView)
...
if bFinal
    ...
    load (shftffn);
%     iFrac = iFig-1;
    xyzShift = [shft.x(iSec) shft.y(iSec) shft.z(iSec)];
